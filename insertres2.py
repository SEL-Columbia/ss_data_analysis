...
if __name__=="__main__":
   ...
   for (dirpath,dirnames,filenames) in os.walk('/home/apan3/sqllite'):
             ...
             try:
               ...
               for (ts,w)  in c.execute(cmd):  
                    ...
                    if curr==prev:
                      ...
                      v[ts]=w
                    if prev!="YYYY-mm-dd HH:MM:SS" and curr[0:10]!=prev[0:10]:# daily wattage resolution
                         ...
                         v={}
                         d.append((prev[0:10]+" 00:00:00",totalwh,))
                    prev=curr


               c.executemany('insert into daily_res_watthours values(?,?)',d)
