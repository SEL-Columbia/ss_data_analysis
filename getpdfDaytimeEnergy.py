...
if __name__=="__main__":
    ...
    for (_min,_max) in r:
      ...
      cnt=0
      cnt=sum([1   for ts,wh in v.items() if (wh>=_min and wh<=_max) and ((int(ts[11:13])>=7 and int(ts[11:13])<=11)or(int(ts[11:13])>=12 and int(ts[11:13])<=18 ) )    ] )
      if cnt==0:
         _d.append(0)
      else:
         _d.append(cnt)
    ...
    plt.savefig("/root/ts/timeseries/timeseries/static/images/DayEnergyHist"+site+".png")
